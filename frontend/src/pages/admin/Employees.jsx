...
const employees = [
  { id: 'E-217', name: 'Tan Jia Yin', dept: 'Engineering', level: 2, points: 1240, status: 'Active' },
  ...
  return (
    <>
      <div className="flex justify-between items-start">
        ...
        <input placeholder="Search employees…" className="bg-card border-2 border-[#d8cfae] rounded-lg px-4 py-2 text-sm outline-none" />
      </div>
          ...
          <tbody>
            {employees.map(e => (
              <tr key={e.id} className="border-b border-[#eee5cf] last:border-0">
                ...
                <td className="px-4 font-bold text-navy">{e.name}</td>
